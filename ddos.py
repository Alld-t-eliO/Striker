...
from delay_jitter import DelayJitter, RateLimiter, backoff_delay
from adaptive_backoff import AdaptiveBackoff
from request_fragmenter import RequestFragmenter
from captcha_waf_bypass import CaptchaWafBypass
from distributed_bots import DistributedBotPool, BotContext, Task
...
def _default_handler(task: Task, ctx: BotContext) -> Dict[str, Any]:
    """Handler simple : GET task.url via le contexte (proxy + UA + backoff)."""
    import requests
